...
from src.acquisition_function import optimize_acqf_vanilla_bo, optimize_acqf_custom_bo, optimize_acqf_lkg
...
prior_dict = {
    "prior": {
        ...
        "log_normal":  gpytorch.priors.LogNormalPrior,
    }
}
constraint_dict = {
    "constraint": {
...
def evaluate_(
    ...
    for key, value in config.items():
        ...
        elif (key == "optimize_acqf_config") and (value["q"] == "dim_search_space"):
            value["q"] = dim_search_space
        elif key == "bounds":
